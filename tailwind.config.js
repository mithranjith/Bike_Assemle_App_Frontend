  ...
  plugins: [
    ...
    plugin(function ({ addBase, addComponents, addUtilities }) {
      ...
      addComponents({
        ...
        ".btn": {
          "@apply inline-flex items-center tracking-wide justify-center h-12 px-5.5 border-2 rounded-xl base2 font-semibold transition-colors disabled:opacity-20 disabled:pointer-events-none":
            {},
        },
        ".btn svg": {
