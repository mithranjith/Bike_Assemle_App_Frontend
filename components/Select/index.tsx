      ...
      {({ open }) => (
        <>
          ...
          >
            {title && (
              <div
                // className="shrink-0 mr-2 pr-2 border-r border-n-3 text-n-4 dark:border-n-4/50"
            ...
            {range && (
              <div className="mr-15 pr-2 border-r border-n-3 text-n-4 dark:border-n-4/50">
                {range}
              </div>
            )}
            {value?.color && (
            ...
            <span
              className={`mr-auto truncate ${value?.icon && "!pl-13"} ${
                small && "font-semibold"
              }`}
            >
              {value ? (
                ...
                <span className={`text-n-4 ${value?.icon && "!pl-13"}`}>
                  {placeholder}
                </span>
              )}
            </span>
