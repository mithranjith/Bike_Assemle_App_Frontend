...
const Checkbox = ({
  ...
  >
    ...
    />
    <span
      className={`relative flex justify-center items-center shrink-0 w-6 h-6 rounded border-2 border-n-3 transition-colors group-hover:bg-purple-600 dark:border-n-5 ${
        value ? "bg-primary-1 " : "bg-transparent"
      }`}
    >
      <Icon
