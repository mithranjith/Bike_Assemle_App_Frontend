...
const Metrics = () => {
  ...
  const metrics = [
    { name: "Number of Chats", value: 32, color: "#0084FF" },
    { name: "Recommendations", value: 30, color: "#46DEFF" },
    { name: "Purchases", value: 15, color: "#9747FF" },
  ];
  ...
  return (
    <Grid container spacing={2} className="justify-center">
      {metrics.map((metric, index) => (
        ...
        >
          <div className="text-2xl text-n-4 font-semibold sm:text-xl flex justify-center items-baseline">
